    ...
    socket.on("message_recieved", (newMessageRecieved) => {
      ...
      if (
        ...
        if(!notification.includes(newMessageRecieved)) {
          ...
          // console.log("in the if already wala");
        ...
        //   prevMessages.concat([newMessageRecieved])
        // );
        // setMessages((prevMessages) => [...prevMessages, newMessageRecieved]);
  ...
  const sendMessage = async (event) => {
    if (event.key === "Enter" && newMessage) {
      ...
      try {
        ...
        // setMessages((prevMessages) => [...prevMessages, data]); // Update the messages state correctly

        // Update your own chat UI
        // setMessages([...messages, data]);

        // socket.emit("new message", data, (response) => {
        //   console.log("in the socket")
        //   if (response.success) {
        //     console.log("enter in the if 1st");
